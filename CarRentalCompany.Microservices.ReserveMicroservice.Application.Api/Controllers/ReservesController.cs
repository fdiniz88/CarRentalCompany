...
namespace CarRentalCompany.Microservices.ReserveMicroservice.Application.Api.Controllers
{
   // [Authorize(Roles = "ReserveHolder")]
    ...
    public class ReservesController : ControllerBase
    {
        ...
        /// </returns>
        [HttpGet("{CarId}")]
        public async Task<IEnumerable<Reserve>> GetCars(Guid CarId)
        {
            return await _ReserveService.GetCarStatement(CarId);
        }
