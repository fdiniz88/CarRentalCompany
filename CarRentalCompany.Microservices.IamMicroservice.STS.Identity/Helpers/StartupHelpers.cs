...
using SendGrid;
using CarRentalCompany.Microservices.IamMicroservice.Shared.Configuration.Email;
using CarRentalCompany.Microservices.IamMicroservice.Shared.Email;
using CarRentalCompany.Microservices.IamMicroservice.STS.Identity.Configuration;
using CarRentalCompany.Microservices.IamMicroservice.STS.Identity.Configuration.ApplicationParts;
using CarRentalCompany.Microservices.IamMicroservice.STS.Identity.Configuration.Constants;
using CarRentalCompany.Microservices.IamMicroservice.STS.Identity.Configuration.Interfaces;
using CarRentalCompany.Microservices.IamMicroservice.STS.Identity.Helpers.Localization;
using System.Linq;
