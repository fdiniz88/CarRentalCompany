...
using CarRentalCompany.Microservices.IamMicroservice.Admin.ExceptionHandling;
using CarRentalCompany.Microservices.IamMicroservice.Admin.Configuration;
using CarRentalCompany.Microservices.IamMicroservice.Admin.Configuration.ApplicationParts;
using CarRentalCompany.Microservices.IamMicroservice.Admin.Configuration.Constants;
using CarRentalCompany.Microservices.IamMicroservice.Admin.Configuration.Interfaces;
using Skoruba.IdentityServer4.Admin.EntityFramework.Interfaces;
using Skoruba.IdentityServer4.Admin.EntityFramework.Repositories;
using Skoruba.IdentityServer4.Admin.EntityFramework.Repositories.Interfaces;
using CarRentalCompany.Microservices.IamMicroservice.Admin.Helpers.Localization;
using System.Linq;
using CarRentalCompany.Microservices.IamMicroservice.Admin.EntityFramework.MySql.Extensions;
using CarRentalCompany.Microservices.IamMicroservice.Admin.EntityFramework.Shared.Configuration;
using CarRentalCompany.Microservices.IamMicroservice.Admin.EntityFramework.SqlServer.Extensions;
using CarRentalCompany.Microservices.IamMicroservice.Admin.EntityFramework.PostgreSQL.Extensions;
using Skoruba.IdentityServer4.Admin.EntityFramework.Helpers;
using Microsoft.AspNetCore.DataProtection.EntityFrameworkCore;
using CarRentalCompany.Microservices.IamMicroservice.Shared.Authentication;
using CarRentalCompany.Microservices.IamMicroservice.Shared.Configuration.Identity;

namespace CarRentalCompany.Microservices.IamMicroservice.Admin.Helpers
{
