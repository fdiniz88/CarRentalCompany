...
using CarRentalCompany.Microservices.IamMicroservice.Admin.Api.Configuration.Authorization;
using CarRentalCompany.Microservices.IamMicroservice.Admin.Api.ExceptionHandling;
using CarRentalCompany.Microservices.IamMicroservice.Admin.Api.Helpers;
using CarRentalCompany.Microservices.IamMicroservice.Admin.Api.Mappers;
using CarRentalCompany.Microservices.IamMicroservice.Admin.Api.Resources;
using CarRentalCompany.Microservices.IamMicroservice.Admin.EntityFramework.Shared.DbContexts;
using CarRentalCompany.Microservices.IamMicroservice.Admin.EntityFramework.Shared.Entities.Identity;
using CarRentalCompany.Microservices.IamMicroservice.Shared.Dtos;
using CarRentalCompany.Microservices.IamMicroservice.Shared.Dtos.Identity;
using CarRentalCompany.Microservices.IamMicroservice.Shared.Helpers;

namespace CarRentalCompany.Microservices.IamMicroservice.Admin.Api
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            services.AddDataProtection()
                .SetApplicationName("CarRentalCompany.Microservices.IamMicroservice")
